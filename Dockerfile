...
RUN if [ "${DOWNLOAD_NETRISWEBAPI}" = "true" ]; then git clone -b extensions https://github.com/jumpojoy/netriswebapi.git /tmp/netriswebapi; else ls -lah ./; mv netriswebapi/ /tmp/; fi
